...
> [!WARNING]
> **Deprecated:** This action is being archived and replaced by [asana-github-sync](https://github.com/planningcenter/asana-github-sync). Please migrate any existing workflows to use the new action. This repository will be archived soon.
